...
BOT_FACES = {
    ...
    "planner": {
        ...
        "idea": "Три шага подряд на 5 минутах: цена оттянулась как резинка, потом ложный выход за уровень, потом заход обратно. Берёт только если все три сложились. Живее на серебре.",
    },
    "idea-004-observe": {
        "title": "Серебро · наблюдение",
        "metal": "Серебро",
        "idea": "Ждёт сжатие, потом выход цены за уровень полос — и только если ход уже сильный. Если рынок перегрет, вероятность пропускает. Свеча 15 минут, серебро.",
    },
    "mv-m5-impulse": {
    ...
    "xag-sweep": {
        ...
        "metal": "Серебро",
        "idea": "На серебре, свеча 15 минут. Цена выбивает уровень последних пяти свечей и закрывается обратно. Стоп чуть за этим уровнем, цель дальше риска в два с половиной раза. Смотрит только дневные часы в будни. По пробе около 15 закрытий в неделю.",
    },
    "xau-sweep": {
        "title": "Золото · ложный пробой",
        "metal": "Золото",
        "idea": "Та же идея ложного уровня, но на золоте: 15 минут, вынос последних пяти свечей и закрытие обратно. Стоп чуть за уровнем, цель дальше риска в два с половиной раза. Дневные часы, будни. По пробе около 18 закрытий в неделю.",
    },
}
